...
| `M02_carryover_timeframe` | `wrong_tool` | `social_search(query="robotics")` | Model đổi web/news intent thành social ở lượt sau | Bổ sung source, topic và timeframe carryover rule |
